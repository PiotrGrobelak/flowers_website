    ...
    <StyledPayment>
      ...
      <StyledList>
        <StyledItem>
          ...
          <p>
            The minimum delivery time is 1 hour or at your appointed time. We
            deliver personally!
          </p>
        </StyledItem>
        <StyledItem>
        ...
        <StyledItem>
          ...
          <p>
            After completing the order, we send an SMS notification about the
            delivery of the bouquet to the recipient.
          </p>
        </StyledItem>
      </StyledList>
